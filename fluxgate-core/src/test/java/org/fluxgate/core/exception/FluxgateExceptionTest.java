...
class FluxgateExceptionTest {
  ...
  class ConfigurationExceptionTests {
    ...
    void shouldNotBeRetryable() {
      FluxgateConfigurationException exception = new FluxgateConfigurationException("config error");
  ...
  class MissingConfigurationTests {
    ...
    void shouldIncludePropertyName() {
      MissingConfigurationException exception =
          new MissingConfigurationException("fluxgate.redis.uri", "Redis URI is required");
  ...
  class ConnectionExceptionTests {
    ...
    void shouldBeRetryable() {
      FluxgateConnectionException exception = new FluxgateConnectionException("connection failed");
    ...
    void shouldIncludeRedisUri() {
      RedisConnectionException exception =
          new RedisConnectionException(
              "connection failed", "redis://***@localhost:6379", new RuntimeException("timeout"));
  ...
  class OperationExceptionTests {
    ...
    void shouldNotBeRetryableByDefault() {
      FluxgateOperationException exception = new FluxgateOperationException("operation failed");
    ...
    void shouldRespectRetryableFlag() {
      FluxgateOperationException retryable =
          new FluxgateOperationException("operation failed", new RuntimeException(), true);

      FluxgateOperationException notRetryable =
          new FluxgateOperationException("operation failed", new RuntimeException(), false);
  ...
  class TimeoutExceptionTests {
    ...
    void shouldIncludeTimeoutInformation() {
      ...
      FluxgateTimeoutException exception = new FluxgateTimeoutException("redis-connect", timeout);
