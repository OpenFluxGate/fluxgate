 ...
 *
 * <p>RequestContext represents contextual information about the incoming request. It allows custom
 * KeyResolvers and strategies to determine which rate-limit bucket should be used.
 */
...
class RequestContextTest {
  ...
  class BuilderTests {
    ...
    void build_shouldAllowPartialContext() {
      // given / when
      RequestContext context =
          RequestContext.builder().clientIp("10.0.0.1").endpoint("/health").build();
  ...
  class GetterTests {
    ...
    void getClientIp_shouldReturnCorrectIp() {
      ...
      RequestContext context = RequestContext.builder().clientIp(expectedIp).build();
    ...
    void getUserId_shouldReturnCorrectUserId() {
      ...
      RequestContext context = RequestContext.builder().userId(expectedUserId).build();
    ...
    void getApiKey_shouldReturnCorrectApiKey() {
      ...
      RequestContext context = RequestContext.builder().apiKey(expectedApiKey).build();
    ...
    void getEndpoint_shouldReturnCorrectEndpoint() {
      ...
      RequestContext context = RequestContext.builder().endpoint(expectedEndpoint).build();
  ...
  class AttributesTests {
    ...
    void attribute_shouldAddSingleAttribute() {
      // given / when
      RequestContext context = RequestContext.builder().attribute("tenantId", "tenant-123").build();
  ...
  class ImmutabilityTests {
    ...
    void getAttributes_shouldReturnUnmodifiableMap() {
      // given
      RequestContext context = RequestContext.builder().attribute("key", "value").build();
    ...
    void getAttributes_shouldNotAllowRemoval() {
      ...
      // then
      assertThrows(UnsupportedOperationException.class, () -> attrs.remove("key"));
    }
  ...
  class EdgeCaseTests {
    ...
    void shouldHandleEmptyStringValues() {
      // given / when
      RequestContext context =
          RequestContext.builder().clientIp("").userId("").endpoint("").build();
    ...
    void shouldHandleLongAttributeValues() {
      ...
      // when
      RequestContext context = RequestContext.builder().attribute("longValue", longValue).build();
