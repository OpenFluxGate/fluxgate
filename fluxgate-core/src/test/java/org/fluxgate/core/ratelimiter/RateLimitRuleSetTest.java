 ...
 * <p>
 * RateLimitRuleSet groups related rate limit rules together with
 * a key resolution strategy and optional metrics recording.
 */
...
class RateLimitRuleSetTest {
    ...
    class BuilderTests {
        ...
        void build_shouldCreateRuleSetWithRequiredFields() {
            ...
            // when
            RateLimitRuleSet ruleSet = RateLimitRuleSet.builder(id)
                    .rules(List.of(rule))
        ...
        void build_shouldPreserveRuleOrder() {
            ...
            // when
            RateLimitRuleSet ruleSet = RateLimitRuleSet.builder("test-set")
    ...
    class GetterTests {
        ...
        void getId_shouldReturnCorrectId() {
            ...
            RateLimitRuleSet ruleSet = RateLimitRuleSet.builder(expectedId)
                    .rules(List.of(createRule("rule-1")))
                    .keyResolver(createKeyResolver())
                    .build();
    ...
    class KeyResolverIntegrationTests {
        ...
        void keyResolver_shouldHandleDifferentStrategies() {
            ...
            RateLimitRuleSet apiKeySet = RateLimitRuleSet.builder("api-key-set")
                    .rules(List.of(createRule("rule-1")))
