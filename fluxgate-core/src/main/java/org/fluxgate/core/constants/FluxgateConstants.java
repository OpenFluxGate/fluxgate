 ...
 * <ul>
 *   <li>HTTP headers used for rate limiting and tracing</li>
 *   <li>MDC (Mapped Diagnostic Context) keys for structured logging</li>
 * </ul>
 */
public final class FluxgateConstants {
     ...
     *
     * <p>These keys are used with SLF4J MDC to provide context in log messages.
     * When using JSON logging (e.g., LogstashEncoder), these become searchable fields.
     */
