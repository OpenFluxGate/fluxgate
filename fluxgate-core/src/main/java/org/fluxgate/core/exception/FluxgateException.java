 ...
 *
 * <p>This is the root of the FluxGate exception hierarchy. All FluxGate-specific
...
public abstract class FluxgateException extends RuntimeException {
     ...
     *
     * <p>Subclasses can override this method to indicate whether the operation
     * that caused this exception can be retried.
     *
