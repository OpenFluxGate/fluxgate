 ...
 *
 * <p>This exception indicates a configuration problem that prevents FluxGate from starting or
 * operating correctly. Configuration exceptions are not retryable as they require manual
 * intervention to fix.
 */
