 ...
 *
 * <p>This is the base class for all runtime operation exceptions in FluxGate.
 * Operation exceptions may or may not be retryable depending on the specific
 * failure cause.
 *
 */
public class FluxgateOperationException extends FluxgateException {
    ...
    /**
     * Constructs a new FluxgateOperationException with the specified message, cause, and
     * retryable flag.
     *
     * @param message the detail message
     * @param cause the cause of the exception
