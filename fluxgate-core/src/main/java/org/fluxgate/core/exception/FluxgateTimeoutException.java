 ...
 * <ul>
 *   <li>A connection attempt exceeds the configured timeout</li>
 *   <li>A rate limit operation takes too long</li>
 *   <li>A script execution exceeds the timeout limit</li>
 * </ul>
 *
 * <p>Timeout exceptions are typically retryable as they may be caused by
 * temporary load spikes or network congestion.
 *
 */
