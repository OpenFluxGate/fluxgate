...
class FluxgateResilienceAutoConfigurationTest {
    ...
    private final ApplicationContextRunner contextRunner =
            new ApplicationContextRunner()
                    .withConfiguration(
                            AutoConfigurations.of(FluxgateResilienceAutoConfiguration.class));
                    ...
                    .run(
                            context -> {
                                ResilientExecutor executor =
                                        context.getBean(ResilientExecutor.class);
                                assertThat(executor.getRetryExecutor())
                                        .isInstanceOf(DefaultRetryExecutor.class);
                                assertThat(executor.getCircuitBreaker())
                                        .isInstanceOf(DefaultCircuitBreaker.class);
                            });
        }
    }
            ...
            contextRunner
                    ...
                    .run(
                            context -> {
                                ...
                                assertThat(props.getCircuitBreaker().getFailureThreshold())
                                        .isEqualTo(7);
                            });
        }
    }
