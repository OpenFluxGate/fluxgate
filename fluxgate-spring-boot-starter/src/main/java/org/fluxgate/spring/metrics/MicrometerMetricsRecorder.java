 ...
 *   <li>{@code fluxgate.requests} - Requests by result (counter, tagged with result=allowed/rejected)</li>
 *   <li>{@code fluxgate.requests.duration} - Request processing duration (timer)</li>
 *   <li>{@code fluxgate.tokens.remaining} - Remaining tokens (gauge)</li>
 * </ul>
 *
 * <p>All metrics are tagged with:
 * <ul>
 *   <li>{@code rule_set} - The rule set ID applied</li>
 *   <li>{@code endpoint} - The request endpoint</li>
...
public class MicrometerMetricsRecorder implements RateLimitMetricsRecorder {
    ...
    private String buildKey(String name, String ruleSetId, String endpoint, String method, String result) {
        StringBuilder sb = new StringBuilder(name)
                .append(":").append(sanitize(ruleSetId))
                .append(":").append(sanitize(endpoint))
                .append(":").append(sanitize(method));
        if (result != null) {
