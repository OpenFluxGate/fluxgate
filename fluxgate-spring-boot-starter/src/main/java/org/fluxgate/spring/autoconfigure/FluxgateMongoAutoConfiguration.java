...
public class FluxgateMongoAutoConfiguration {
     ...
     * <p>
     * Uses MongoDB implementation. Users can provide their own implementation
     * by defining a bean of type {@link RateLimitRuleRepository}.
     */
    @Bean
     ...
     * <p>
     * Uses the collection name from {@code fluxgate.mongo.event-collection}.
     */
     ...
     * <p>
     * This recorder stores all rate limit decisions (allowed/denied) to MongoDB
