 ...
 * <p>
 * RateLimitBandDocument represents a rate limit band document for MongoDB storage.
 */
    ...
    class ConstructorTests {
        ...
        void constructor_shouldThrowWhenLabelIsNull() {
            ...
            assertThrows(
                    ...
                    () -> new RateLimitBandDocument(60, 100, null)
            );
        }
        ...
        void constructor_shouldThrowWhenWindowSecondsIsZero() {
            ...
            IllegalArgumentException exception = assertThrows(
                    ...
                    () -> new RateLimitBandDocument(0, 100, "test")
            );
        ...
        void constructor_shouldThrowWhenWindowSecondsIsNegative() {
            ...
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new RateLimitBandDocument(-1, 100, "test")
            );
        }
        ...
        void constructor_shouldThrowWhenCapacityIsZero() {
            ...
            IllegalArgumentException exception = assertThrows(
                    IllegalArgumentException.class,
                    () -> new RateLimitBandDocument(60, 0, "test")
            );
        ...
        void constructor_shouldThrowWhenCapacityIsNegative() {
            ...
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new RateLimitBandDocument(60, -10, "test")
            );
        }
    }
