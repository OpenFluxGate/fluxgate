 ...
 * <p>
 * RateLimitRuleDocument represents a rate limit rule document for MongoDB storage.
 */
...
class RateLimitRuleDocumentTest {
    ...
    class ConstructorTests {
        ...
        void constructor_shouldCreateDocumentWithMultipleBands() {
            ...
            // when
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "rule-1", "Multi-Band Rule", true,
                    LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST, bands, "default"
            );
        ...
        void constructor_shouldThrowWhenIdIsNull() {
            ...
            assertThrows(NullPointerException.class, () ->
                    new RateLimitRuleDocument(
                            null, "name", true,
                            LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                            List.of(createBandDocument(60, 100)), "ruleset"
                    )
            );
        }
        ...
        void constructor_shouldThrowWhenScopeIsNull() {
            ...
            assertThrows(NullPointerException.class, () ->
                    new RateLimitRuleDocument(
                            "id", "name", true,
                            null, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                            List.of(createBandDocument(60, 100)), "ruleset"
                    )
            );
        }
        ...
        void constructor_shouldThrowWhenRuleSetIdIsNull() {
            ...
            assertThrows(NullPointerException.class, () ->
                    new RateLimitRuleDocument(
                            "id", "name", true,
                            LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                            List.of(createBandDocument(60, 100)), null
                    )
            );
        }
    }
    ...
    class GetterTests {
        ...
        void getName_shouldReturnCorrectValue() {
            // given
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "id", "Custom Name", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                    List.of(createBandDocument(60, 100)), "default"
            );
        ...
        void isEnabled_shouldReturnCorrectValue() {
            // given
            RateLimitRuleDocument enabledDoc = new RateLimitRuleDocument(
                    "id", "name", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                    List.of(createBandDocument(60, 100)), "default"
            );
            RateLimitRuleDocument disabledDoc = new RateLimitRuleDocument(
                    "id", "name", false, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                    List.of(createBandDocument(60, 100)), "default"
            );
        ...
        void getScope_shouldReturnCorrectValue() {
            // given
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "id", "name", true, LimitScope.PER_USER, "userId", OnLimitExceedPolicy.REJECT_REQUEST,
                    List.of(createBandDocument(60, 100)), "default"
            );
        ...
        void getBands_shouldReturnImmutableCopy() {
            ...
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "id", "name", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST, bands, "default"
            );
        ...
        void getRuleSetId_shouldReturnCorrectValue() {
            ...
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "id", "name", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                    List.of(createBandDocument(60, 100)), "my-ruleset"
            );
        ...
        void getOnLimitExceedPolicy_shouldReturnCorrectValue() {
            // given
            RateLimitRuleDocument document = new RateLimitRuleDocument(
                    "id", "name", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.WAIT_FOR_REFILL,
                    List.of(createBandDocument(60, 100)), "default"
            );
    ...
    class EdgeCaseTests {
        ...
        void shouldHandleAllScopeTypes() {
            // given
            LimitScope[] scopes = {LimitScope.GLOBAL, LimitScope.PER_API_KEY, LimitScope.PER_USER, LimitScope.PER_IP};

            // when / then
            for (LimitScope scope : scopes) {
                RateLimitRuleDocument document = new RateLimitRuleDocument(
                        "id", "name", true, scope, "key", OnLimitExceedPolicy.REJECT_REQUEST,
                        List.of(createBandDocument(60, 100)), "default"
                );
                assertEquals(scope, document.getScope());
            }
        ...
        void shouldHandleAllPolicyTypes() {
            ...
            for (OnLimitExceedPolicy policy : policies) {
                RateLimitRuleDocument document = new RateLimitRuleDocument(
                        "id", "name", true, LimitScope.PER_IP, "ip", policy,
                        List.of(createBandDocument(60, 100)), "default"
                );
    ...
    private RateLimitRuleDocument createDefaultDocument(String id) {
        return new RateLimitRuleDocument(
                id, "Default Rule", true, LimitScope.PER_IP, "ip", OnLimitExceedPolicy.REJECT_REQUEST,
                List.of(createBandDocument(60, 100)), "default"
        );
    }
}
