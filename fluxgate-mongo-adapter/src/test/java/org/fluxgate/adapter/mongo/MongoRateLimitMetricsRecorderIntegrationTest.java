...
class MongoRateLimitMetricsRecorderIntegrationTest {
    ...
    void record_shouldIncludeValidTimestamp() {
        ...
        assertTrue(recordedTimestamp >= beforeRecording,
                "Timestamp should be >= time before recording");
        assertTrue(recordedTimestamp <= afterRecording,
                "Timestamp should be <= time after recording");
    }
