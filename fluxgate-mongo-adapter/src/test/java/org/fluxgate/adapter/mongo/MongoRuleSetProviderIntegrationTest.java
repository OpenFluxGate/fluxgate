...
class MongoRuleSetProviderIntegrationTest {
  ...
  void findById_shouldLoadRuleSetFromMongo() {
    ...
    // Create a band
    RateLimitBandDocument bandDoc = new RateLimitBandDocument(1L, 100L, "per-second");
  ...
  void findById_shouldLoadDisabledRules() {
    ...
    RateLimitRuleDocument disabledRule =
        new RateLimitRuleDocument(
            "disabled-rule",
            "Disabled Rule",
            false, // disabled
  ...
  void repository_upsertShouldUpdateExistingRule() {
    ...
    RateLimitRuleDocument initialRule =
        new RateLimitRuleDocument(
            "update-rule",
            "Initial Name",
            true,
    ...
    RateLimitRuleDocument updatedRule =
        new RateLimitRuleDocument(
            "update-rule", // same id
  ...
  /**
   * Test KeyResolver implementation Adjust method signature to match the actual interface if
   * needed.
   */
