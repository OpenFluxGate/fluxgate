 ...
 * <p>
 * Stores RuleSet data as Redis Hashes for efficient retrieval.
 * Key format: fluxgate:ruleset:{ruleSetId}
 */
public class RedisRuleSetStore {
    ...
    public void save(RuleSetData ruleSetData) {
        ...
        hash.put("keyStrategyId", ruleSetData.getKeyStrategyId() != null ? ruleSetData.getKeyStrategyId() : "clientIp");
