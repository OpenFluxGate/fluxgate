...
public final class LuaScripts {
    ...
    /**
     * SHA-256 hash of the token bucket consume script.
     * This is set after the script is loaded into Redis.
     */
    private static volatile String tokenBucketConsumeSha;

    /**
     * The actual Lua script content for token bucket consume.
     * Loaded from resources/lua/token_bucket_consume.lua
     */
