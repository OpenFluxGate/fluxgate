 ...
 * <p>
 * This endpoint is limited to 10 requests per minute per IP address.
 * The rate limit is enforced by the FluxgateRateLimitFilter.
 */
@RestController
...
public class TestController {
    ...
    @GetMapping
    @Operation(summary = "Rate-limited test endpoint",
               description = "This endpoint is rate-limited to 10 requests per minute per IP. " +
