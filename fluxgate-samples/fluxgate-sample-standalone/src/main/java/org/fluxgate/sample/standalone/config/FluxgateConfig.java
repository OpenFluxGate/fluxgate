 ...
 * <p>
 * Sets up:
 * - MongoDB connection for rule storage
 * - Redis connection for rate limiting
 * - FluxGate components (RateLimiter, RuleSetProvider)
 */
@Configuration
public class FluxgateConfig {
    ...
    @Value("${fluxgate.mongodb.uri:mongodb://fluxgate:fluxgate123@localhost:27017/fluxgate?authSource=admin}")
    ...
    @Bean
    public RateLimitRuleRepository ruleRepository(MongoCollection<Document> rateLimitRulesCollection) {
