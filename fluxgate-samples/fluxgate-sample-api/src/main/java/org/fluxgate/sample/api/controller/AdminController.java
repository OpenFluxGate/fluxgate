...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> initRules() {
        ...
        Map<String, Object> response = controlPlaneClient.post()
    ...
    public ResponseEntity<List<Map<String, Object>>> listRules(
        ...
        List<Map<String, Object>> rules = controlPlaneClient.get()
    ...
    public ResponseEntity<Void> deleteRule(
        ...
        controlPlaneClient.delete()
                .uri("/admin/rules/{id}", id)
                .retrieve()
                .toBodilessEntity();
    ...
    @Operation(
            ...
            description = "Fetches rules from MongoDB and registers them as a RuleSet in Redis Data-plane"
    )
    ...
    public ResponseEntity<Map<String, Object>> syncRulesToRedis(
        ...
        if (rules == null || rules.isEmpty()) {
            return ResponseEntity.badRequest().body(Map.of(
                    "error", "No rules found in MongoDB",
                    "ruleSetId", ruleSetId
            ));
        }
        ...
        Map<String, Object> ruleSetRequest = Map.of(
                "ruleSetId", ruleSetId,
                "capacity", capacity,
                "windowSeconds", windowSeconds
        );

        Map<String, Object> redisResponse = dataPlaneClient.post()
                .uri("/admin/rules")
