...
public class ApiController {
    ...
    @Operation(
            ...
            description = "Tests rate limiting with the specified RuleSet. Returns 429 if rate limit exceeded."
    )
    @ApiResponses({
    ...
    public ResponseEntity<Map<String, Object>> testRateLimit(
            ...
            @RequestParam(value = "ruleSetId", defaultValue = "api-limits") String ruleSetId,
    ...
    @Operation(
            ...
            description = "Returns service status (no rate limiting)"
    )
