 ...
 * <p>
 * Notice: There is NO rate limiting code in this controller!
 * All rate limiting is handled automatically by {@code FluxgateRateLimitFilter}.
 */
@RestController
@RequestMapping("/api")
...
public class ApiController {
    ...
    public ResponseEntity<Map<String, Object>> hello() {
        ...
        return ResponseEntity.ok(Map.of(
                "message", "Hello from FluxGate!",
                "requestNumber", count,
                "note", "This endpoint is rate-limited automatically by FluxgateRateLimitFilter",
