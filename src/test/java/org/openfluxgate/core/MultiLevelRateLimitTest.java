 ...
 *
 * Scenario: Service A (using 1 API Key)
 * 1) IP-based limit: 100 requests per minute per IP
 * 2) Service-wide limit: 10,000 requests per 10 minutes total
 */
class MultiLevelRateLimitTest {
    ...
    void approach1_SequentialRuleSetChecks() {
        ...
        RateLimitBand ipBand = RateLimitBand.builder(Duration.ofMinutes(1), 100)
                .label("IP-1min-100req")
                .build();

        RateLimitRule ipRule = RateLimitRule.builder("ip-limit")
                .name("IP-based Limit")
        ...
        RateLimitRuleSet ipRuleSet = RateLimitRuleSet.builder("ip-limiter")
        ...
        RateLimitBand serviceBand = RateLimitBand.builder(Duration.ofMinutes(10), 10000)
                .label("Service-10min-10000req")
                .build();

        RateLimitRule serviceRule = RateLimitRule.builder("service-limit")
        ...
        RateLimitRuleSet serviceRuleSet = RateLimitRuleSet.builder("service-limiter")
        ...
        RequestContext ip1 = RequestContext.builder()
                .clientIp("10.0.0.1")
                .apiKey("service-a-key")
                .build();

        RequestContext ip2 = RequestContext.builder()
                .clientIp("10.0.0.2")
                .apiKey("service-a-key")
                .build();
        ...
        System.out.println("    Service limit: " + (service1Check101.isAllowed() ? "Allowed" : "Rejected (100 consumed)"));
        System.out.println();
        ...
        assertThat(service2Check.getRemainingTokens()).isEqualTo(9898); // 10000 - 100(ip1 normal) - 1(ip1 101st service check) - 1(ip2) = 9898
    ...
    void approach2_HelperFunctionUsage() {
        ...
        // IP limit RuleSet
        RateLimitBand ipBand = RateLimitBand.builder(Duration.ofMinutes(1), 5)
                .label("IP-1min-5req")
                .build();
        ...
        RateLimitBand serviceBand = RateLimitBand.builder(Duration.ofMinutes(10), 20)
                .label("Service-10min-20req")
                .build();
        ...
        MultiLevelRateLimitChecker checker = new MultiLevelRateLimitChecker(
                rateLimiter, ipRuleSet, serviceRuleSet
        );
    ...
    static class MultiLevelRateLimitChecker {
        ...
        public MultiLevelRateLimitChecker(RateLimiter rateLimiter,
