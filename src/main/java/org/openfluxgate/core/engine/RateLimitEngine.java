package org.openfluxgate.core.engine;
 ...
 *  - Define behavior when rule set is missing
 */
public final class RateLimitEngine {
    ...
    public enum OnMissingRuleSetStrategy {
        ...
        /**
         * Fail-open: allow the request without applying any rate limiting.
         * This will return an "allowed" result with null rule information.
         */
        ALLOW
    }
    ...
    private RateLimitEngine(Builder builder) {
        this.ruleSetProvider = Objects.requireNonNull(builder.ruleSetProvider, "ruleSetProvider must not be null");
